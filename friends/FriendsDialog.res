"Friends/FriendsDialog.res"	
{
	...
	"styles"	
	{
		...
		"AddFriendsButton"	
		{
			...
			"render_bg"	
			{
				"1"		"image( x0, y0 + 4, x1, y1, graphics/i_clientIcon5 )"	
			}
		}
		"AddFriendsButton:hover"	
		{
			...
			"render_bg"	
			{
				"0"		"image( x0, y0 + 4, x1, y1, graphics/i_clientIcon11 )"	
			}
		}
		"RootMenu"	
		{
		...
		"MenuBar MenuButton"	
		{
			...
			"render"	
			{
				"0"		"image( x1-18, y0 + 11, x1-0, y1, graphics/i_clientIcon31 )"	
			}
		}
		"MenuBar MenuButton:hover"	
		{
			"render"	
			{
				"0"		"image( x1-18, y0 + 11, x1-0, y1, graphics/i_clientIcon33 )"	
			}
		}
		...
		"FriendsSearch"	
		{
			...
			"render_bg"	
			{
				"0"		"fill( x0, y0 + 1, x1, y1, FriendsSearchBG )"	
			}
		}
		"FriendsSearch:empty"	
		{
			"font-style"		"italic"	
			"textcolor"		"ClientTextColorDisabled"	
		}
		"FriendsSearch:hover"	
		{
			"textcolor"		"ClientTextColorHover"	
		...
		"FriendsSearchIcon"	
		{
			"bgcolor"		"none"	
			"inset"		"4 2 0 0"	
			"image"		"graphics/i_clientIcon14"	
			"padding-left"		"0"	
			"padding-right"		"-1"	
			"padding-top"		"-1"	
			"render_bg"	
			{
				"0"		"fill( x0 + 2, y0 - 1, x1 + 2, y1 + 5, FriendsSearchBG )"	
			}
		}
